<?php
   include_once('dispara_email_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['dispara_email']['glo_nm_perfil']          = "principal";
   $_SESSION['scriptcase']['dispara_email']['glo_nm_path_prod']       = "/principal/prod";
   $_SESSION['scriptcase']['dispara_email']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['dispara_email']['glo_nm_path_imagens']    = "/principal/img";
   $_SESSION['scriptcase']['dispara_email']['glo_nm_path_imag_temp']  = "/principal/tmp";
   $_SESSION['scriptcase']['dispara_email']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['dispara_email']['glo_nm_path_doc']        = "/var/www/doc";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['dispara_email']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['dispara_email']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['dispara_email']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['dispara_email']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['dispara_email']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['dispara_email']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['dispara_email']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['dispara_email']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['dispara_email']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['dispara_email']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class dispara_email_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['dispara_email']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "dispara_email"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_hr_criacao   = "001951"; 
      $this->nm_autor_alt    = "admin"; 
      $this->nm_dt_ult_alt   = "20201116"; 
      $this->nm_hr_ult_alt   = "180809"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['dispara_email']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['dispara_email']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['dispara_email']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['dispara_email']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['dispara_email']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['dispara_email']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/dispara_email';
      ...
      if (isset($_SESSION['scriptcase']['dispara_email']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['dispara_email']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['dispara_email']['actual_lang']) || $_SESSION['scriptcase']['dispara_email']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['dispara_email']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("dispara_email_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['dispara_email']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['dispara_email']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['dispara_email']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['dispara_email']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['dispara_email']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['dispara_email']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["dispara_email"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["dispara_email"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['dispara_email']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['dispara_email']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['dispara_email']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['dispara_email']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['dispara_email']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['dispara_email']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "dispara_email_erro.class.php"); 
      $this->Erro = new dispara_email_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('dispara_email'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['dispara_email']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['dispara_email']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['dispara_email']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['dispara_email']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['dispara_email']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['dispara_email']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['dispara_email']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['dispara_email']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['dispara_email']['glo_nm_conexao']) && $_SESSION['scriptcase']['dispara_email']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['dispara_email']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['dispara_email']['glo_nm_perfil']) && $_SESSION['scriptcase']['dispara_email']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['dispara_email']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['dispara_email']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['dispara_email']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['dispara_email']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['dispara_email']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['dispara_email']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dispara_email']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['scriptcase']['dispara_email']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['dispara_email']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['dispara_email']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['dispara_email']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['dispara_email']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['dispara_email']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['dispara_email']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['dispara_email']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['dispara_email']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['dispara_email']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['dispara_email']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['dispara_email']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['dispara_email']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dispara_email']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['dispara_email']['glo_nm_conexao'], $this->root . $this->path_prod, 'mail_marketing', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           $delim  = "'";
           $delim1 = "'";
           if (isset($_SESSION['sc_session'][$this->sc_page]['dispara_email']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['dispara_email']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['dispara_email']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['dispara_email']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['dispara_email']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['dispara_email']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['dispara_email']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['dispara_email']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new dispara_email_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dispara_email']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['dispara_email']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['dispara_email']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['dispara_email'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['dispara_email']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['dispara_email']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('dispara_email') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['dispara_email']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['dispara_email']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['dispara_email']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['dispara_email']['exit'];
      ...
      {
          include_once("dispara_email_sc_mail_image.php");
      }
      $this->nm_data = new nm_data("pt_br");
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "dispara_email_erro.class.php"); 
      $this->Erro      = new dispara_email_erro();
      $this->Erro->Ini = $this->Ini;
//
      $_SESSION['scriptcase']['dispara_email']['contr_erro'] = 'on';
 		
$mail = FALSE;
$i = 0;

$sql_marketing = "SELECT 
					idmail_marketing,
					mail_marketing_campanha,
					mail_marketing_lista,
					mail_marketing_emitente,
					lcase(mail_marketing_assunto) as assunto,
				...
				FROM 
					mail_marketing 
				WHERE 
					mail_marketing_terminar_quando IS NULL";

 
      $nm_select = $sql_marketing; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($this->rs_marketing = $this->Db->Execute($nm_select)) 
      { }
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->rs_marketing = false;
          $this->rs_marketing_erro = $this->Db->ErrorMsg();
      } 
;

if ($this->rs_marketing  !== false) {
	
	while(!$this->rs_marketing->EOF) {

	
		$idmail_marketing = $this->rs_marketing->fields['idmail_marketing'];
		$mail_marketing_campanha = $this->rs_marketing->fields['mail_marketing_campanha'];
		$mail_marketing_lista = $this->rs_marketing->fields['mail_marketing_lista'];
		$mail_marketing_emitente = $this->rs_marketing->fields['mail_marketing_emitente'];
		$mail_marketing_assunto = $this->rs_marketing->fields['assunto'];
		$mail_marketing_conteudo = $this->rs_marketing->fields['mail_marketing_conteudo'];
		$mail_marketing_imagem_cabecalho = $this->rs_marketing->fields['mail_marketing_imagem_cabecalho'];
		$mail_marketing_imagem_rodape = $this->rs_marketing->fields['mail_marketing_imagem_rodape'];
		$mail_marketing_link_conteudo = $this->rs_marketing->fields['mail_marketing_link_conteudo'];
		$mail_marketing_iniciar_quando = $this->rs_marketing->fields['mail_marketing_iniciar_quando'];
		$mail_marketing_terminar_quando = $this->rs_marketing->fields['mail_marketing_terminar_quando'];

		print_r("<H1>$mail_marketing_campanha</H1>");

				
		$update_sql2 = "UPDATE mail_marketing 
						SET mail_marketing_iniciar_quando = now() 
						WHERE idmail_marketing = '$idmail_marketing';";
     ...
     $nm_select = $update_sql2; 
      ...
      ;
		...
		$sql_meio = "SELECT 
						...
						mail_ativo
					FROM 
						mail_meio WHERE idmail_meio = '$mail_marketing_emitente';";

		 
      $nm_select = $sql_meio; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($this->rs_meio = $this->Db->Execute($nm_select)) 
      { }
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->rs_meio = false;
          $this->rs_meio_erro = $this->Db->ErrorMsg();
      } 
;

		if ($this->rs_meio  !== false) {

			$mail_smtp_server = $this->rs_meio->fields["mail_smtp"];
			$mail_smtp_user = $this->rs_meio->fields["mail_usuario"];
			$mail_smtp_pass = $this->rs_meio->fields["mail_senha"];
			$mail_from = $this->rs_meio->fields["mail_usuario"];
			$mail_bbc = 'renatoamori@gmail.com';	
			$mail_format = 'H';
			$i = $i++;
			...
			$sql_contato = "SELECT 
								 t1.*,
								 coalesce(apelido,nome) as chamar
							FROM 
								mail_contato t1,
								mail_lista t2,
								mail_marketing t3
							WHERE
								t1.origem = t2.mail_lista_descricao
								and t2.idmail_lista = t3.mail_marketing_lista
								and t3.mail_marketing_lista = '$mail_marketing_lista'
								and email NOT IN(select mail_enviados_mail FROM mail_enviados WHERE mail_enviados_id_envio = '$idmail_marketing') order by rand() limit 50;";

			 
      $nm_select = $sql_contato; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($this->rs_contato = $this->Db->Execute($nm_select)) 
      { }
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->rs_contato = false;
          $this->rs_contato_erro = $this->Db->ErrorMsg();
      } 
;

			if ($this->rs_contato  !== false) {

				while(!$this->rs_contato->EOF) {

					if(!empty($this->rs_contato->fields["email"])) {
						
					$client_name = $this->rs_contato->fields["chamar"];
					$mail_to = $this->rs_contato->fields["email"];
					$client_sexo = $this->rs_contato->fields["sexo"];
					$saudacao = "Olá $client_name!";
						
					if($client_sexo == "M"){
						
						$saudacao = "Prezado $client_name";
						
						}
					
						if($client_sexo == "F"){
						
						$saudacao = "Prezada $client_name";
						
						}
					
						
						
						$mail_subject = $saudacao . ', '.$mail_marketing_assunto;
						$mail_message = "<div style:'width: 300px;align-items: center><img src='".$mail_marketing_imagem_cabecalho."'>
						<br>$saudacao!<br><br>
						<br>$mail_marketing_conteudo
						<br><img src='".$mail_marketing_link_conteudo."'>
						<br><img src='".$mail_marketing_imagem_rodape."'></div>";
					...
					if($i==50){
						...
						print_r("<br><br><h3>Mensagem:</h3>Processo de envio iniciado, esta pagina ira sendo atualizada a cada 50 envios, você pode continuar trabalhando em outras telas.</br></br></br></br>");
...
;
						...
						print_r('# '. $i .' - '. $mail_to .': ok </br>');


					$update_sql = "INSERT INTO mail_enviados(mail_enviados_mail,mail_enviados_id_envio) VALUES('$mail_to','$idmail_marketing');";
     ...
     $nm_select = $update_sql; 
      ...
      ;
					...
					$this->rs_contato->MoveNext();
				}
				$this->rs_contato->Close();
					...
					$update_sql2 = "UPDATE mail_marketing 
						SET mail_marketing_terminar_quando = now() 
						WHERE idmail_marketing = '$idmail_marketing';";
		
		
			$this->rs_marketing->MoveNext();

		}
	
	$this->rs_marketing->Close();
}

if($mail == FALSE){
	print_r("<h1>Nenhum e-mail enviado</h1>");
	
}else{
	
		print_r("<h1>$i e-mails enviados</h1>");

	}
$_SESSION['scriptcase']['dispara_email']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_dispara_email($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['dispara_email']['glo_nm_path_imag_temp'] . "/sc_apl_default_mail_marketing.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['dispara_email']['glo_nm_path_imag_temp'] . "/sc_apl_default_mail_marketing.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "dispara_email") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['dispara_email']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['dispara_email']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['dispara_email']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_mail_marketing'])) {
               $_SESSION['scriptcase']['dispara_email']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_mail_marketing'];
           }
       }
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['dispara_email']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['dispara_email']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['dispara_email']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "dispara_email";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'dispara_email' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['dispara_email']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['dispara_email']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['dispara_email']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['dispara_email']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['dispara_email']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('dispara_email' == $sReferer || 'dispara_email_' == substr($sReferer, 0, 14))
       {
           $_SESSION['sc_session'][$script_case_init]['dispara_email']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'dispara_email')
   {
       $_SESSION['sc_session'][$script_case_init]['dispara_email']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['dispara_email']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/dispara_email_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_dispara_email($cadapar[1]);
   ...
   $contr_dispara_email = new dispara_email_apl();
   $contr_dispara_email->controle();
//
   function nm_limpa_str_dispara_email(&$str)
   {
