<?php
   ...
   $_SESSION['scriptcase']['teste_email']['glo_nm_path_prod']       = "/principal/prod";
   $_SESSION['scriptcase']['teste_email']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['teste_email']['glo_nm_path_imagens']    = "/principal/img";
   $_SESSION['scriptcase']['teste_email']['glo_nm_path_imag_temp']  = "/principal/tmp";
