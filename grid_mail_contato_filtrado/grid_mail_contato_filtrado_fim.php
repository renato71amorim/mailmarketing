...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["mail_marketing_____grid_mail_contato_filtrado"]))
   {
      unset($_SESSION['session_sec_aplicacao']["mail_marketing_____grid_mail_contato_filtrado"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mail_contato_filtrado']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_mail_contato_filtrado']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mail_contato_filtrado']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_mail_contato_filtrado']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_mail_contato_filtrado']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_mail_contato_filtrado</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_mail_contato_filtrado']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_mail_contato_filtrado']['embutida_filho'] as $ind => $sc_init)
          {
