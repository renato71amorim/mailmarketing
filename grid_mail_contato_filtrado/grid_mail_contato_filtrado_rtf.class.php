...
class grid_mail_contato_filtrado_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_mail_contato_filtrado.rtf";
   }
   //---- 
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mail_contato_filtrado']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mail_contato_filtrado']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
