  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_mail_gatilho_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_mail_gatilho_mob_form();
	}

  // ---------- Validate idmail_gatilho
  function do_ajax_form_mail_gatilho_mob_validate_idmail_gatilho()
  {
    var nomeCampo_idmail_gatilho = "idmail_gatilho";
    var var_idmail_gatilho = scAjaxGetFieldHidden(nomeCampo_idmail_gatilho);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_gatilho_mob_validate_idmail_gatilho(var_idmail_gatilho, var_script_case_init, do_ajax_form_mail_gatilho_mob_validate_idmail_gatilho_cb);
  } // do_ajax_form_mail_gatilho_mob_validate_idmail_gatilho

  function do_ajax_form_mail_gatilho_mob_validate_idmail_gatilho_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idmail_gatilho";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_gatilho_mob_validate_idmail_gatilho_cb

  // ---------- Validate mail_descreva
  function do_ajax_form_mail_gatilho_mob_validate_mail_descreva()
  {
    var nomeCampo_mail_descreva = "mail_descreva";
    var var_mail_descreva = scAjaxGetFieldText(nomeCampo_mail_descreva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_gatilho_mob_validate_mail_descreva(var_mail_descreva, var_script_case_init, do_ajax_form_mail_gatilho_mob_validate_mail_descreva_cb);
  } // do_ajax_form_mail_gatilho_mob_validate_mail_descreva

  function do_ajax_form_mail_gatilho_mob_validate_mail_descreva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_gatilho_mob_validate_mail_descreva_cb

  // ---------- Validate mail_gatilho_sobre
  function do_ajax_form_mail_gatilho_mob_validate_mail_gatilho_sobre()
  {
    var nomeCampo_mail_gatilho_sobre = "mail_gatilho_sobre";
    var var_mail_gatilho_sobre = scAjaxGetFieldText(nomeCampo_mail_gatilho_sobre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_gatilho_mob_validate_mail_gatilho_sobre(var_mail_gatilho_sobre, var_script_case_init, do_ajax_form_mail_gatilho_mob_validate_mail_gatilho_sobre_cb);
  } // do_ajax_form_mail_gatilho_mob_validate_mail_gatilho_sobre

  function do_ajax_form_mail_gatilho_mob_validate_mail_gatilho_sobre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mail_gatilho_sobre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_gatilho_mob_validate_mail_gatilho_sobre_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_mail_gatilho_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_mail_gatilho_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idmail_gatilho = scAjaxGetFieldHidden("idmail_gatilho");
    var var_mail_descreva = scAjaxGetFieldText("mail_descreva");
    var var_mail_gatilho_sobre = scAjaxGetFieldText("mail_gatilho_sobre");
    ...
    scAjaxProcOn();
    x_ajax_form_mail_gatilho_mob_submit_form(var_idmail_gatilho, var_mail_descreva, var_mail_gatilho_sobre, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_mail_gatilho_mob_submit_form_cb);
  } // do_ajax_form_mail_gatilho_mob_submit_form

  function do_ajax_form_mail_gatilho_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idmail_gatilho");
      scAjaxHideErrorDisplay("mail_descreva");
      scAjaxHideErrorDisplay("mail_gatilho_sobre");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_mail_gatilho_mob_submit_form_cb_after_alert);
  } // do_ajax_form_mail_gatilho_mob_submit_form_cb
  function do_ajax_form_mail_gatilho_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_mail_gatilho_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_mail_gatilho_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("mail_descreva");
    scAjaxHideErrorDisplay("mail_gatilho_sobre");
    var var_idmail_gatilho = document.F2.idmail_gatilho.value;
    ...
    scAjaxProcOn();
    x_ajax_form_mail_gatilho_mob_navigate_form(var_idmail_gatilho, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_mail_gatilho_mob_navigate_form_cb);
  } // do_ajax_form_mail_gatilho_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_gatilho_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_mail_gatilho_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idmail_gatilho.value = scAjaxGetKeyValue("idmail_gatilho");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_mail_gatilho_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_mail_gatilho_mob_navigate_form_cb
  function do_ajax_form_mail_gatilho_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_mail_gatilho_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_mail_gatilho_mob_navigate_form_cb_after_alert
  function sc_hide_form_mail_gatilho_mob_form()
  {
  ...
  ajax_field_list[0] = "idmail_gatilho";
  ajax_field_list[1] = "mail_descreva";
  ajax_field_list[2] = "mail_gatilho_sobre";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idmail_gatilho": {"label": "Idmail Gatilho", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "mail_gatilho_sobre": {"label": "Mail Gatilho Sobre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "idmail_gatilho": new Array(),
    "mail_descreva": new Array(),
    "mail_gatilho_sobre": new Array()
  };
  ajax_field_mult["idmail_gatilho"][1] = "idmail_gatilho";
  ajax_field_mult["mail_descreva"][1] = "mail_descreva";
  ajax_field_mult["mail_gatilho_sobre"][1] = "mail_gatilho_sobre";

  var ajax_field_id = {
    "idmail_gatilho": new Array("hidden_field_label_idmail_gatilho", "hidden_field_data_idmail_gatilho"),
    "mail_descreva": new Array("hidden_field_label_mail_descreva", "hidden_field_data_mail_descreva"),
    "mail_gatilho_sobre": new Array("hidden_field_label_mail_gatilho_sobre", "hidden_field_data_mail_gatilho_sobre")
  };

  var ajax_read_only = {
    "idmail_gatilho": "on",
    "mail_descreva": "off",
    "mail_gatilho_sobre": "off"
  };
