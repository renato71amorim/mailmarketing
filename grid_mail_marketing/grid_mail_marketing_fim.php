...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["mail_marketing_____grid_mail_marketing"]))
   {
      unset($_SESSION['session_sec_aplicacao']["mail_marketing_____grid_mail_marketing"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_mail_marketing'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mail_marketing']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_mail_marketing']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mail_marketing']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_mail_marketing']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_mail_marketing']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_mail_marketing</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_mail_marketing']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_mail_marketing']['embutida_filho'] as $ind => $sc_init)
          {
