...
<?php
   ...
   $Ord_Cmp = new grid_mail_marketing_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_mail_marketing_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idmail_marketing'] = "idmail_marketing";
   $tab_labels["idmail_marketing"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['labels']["idmail_marketing"])) ? $_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['labels']["idmail_marketing"] : "Idmail Marketing";
   $tab_ger_campos['mail_marketing_campanha'] = "on";
   $tab_def_campos['mail_marketing_campanha'] = "mail_marketing_campanha";
   $tab_labels["mail_marketing_campanha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['labels']["mail_marketing_campanha"])) ? $_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['labels']["mail_marketing_campanha"] : "Mail Marketing Campanha";
   $tab_ger_campos['mail_marketing_lista'] = "on";
   $tab_def_campos['mail_marketing_lista'] = "mail_marketing_lista";
   $tab_labels["mail_marketing_lista"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['labels']["mail_marketing_lista"])) ? $_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['labels']["mail_marketing_lista"] : "Mail Marketing Lista";
   $tab_ger_campos['mail_marketing_emitente'] = "on";
   $tab_def_campos['mail_marketing_emitente'] = "mail_marketing_emitente";
   $tab_labels["mail_marketing_emitente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['labels']["mail_marketing_emitente"])) ? $_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['labels']["mail_marketing_emitente"] : "Mail Marketing Emitente";
   $tab_ger_campos['mail_marketing_iniciar_quando'] = "on";
   $tab_def_campos['mail_marketing_iniciar_quando'] = "mail_marketing_iniciar_quando";
   $tab_labels["mail_marketing_iniciar_quando"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['labels']["mail_marketing_iniciar_quando"])) ? $_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['labels']["mail_marketing_iniciar_quando"] : "Mail Marketing Iniciar Quando";
   $tab_ger_campos['mail_marketing_terminar_quando'] = "on";
   $tab_def_campos['mail_marketing_terminar_quando'] = "mail_marketing_terminar_quando";
   $tab_labels["mail_marketing_terminar_quando"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['labels']["mail_marketing_terminar_quando"])) ? $_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['labels']["mail_marketing_terminar_quando"] : "Mail Marketing Terminar Quando";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['ordem_quebra'] as $campo => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_mail_marketing_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_mail_marketing']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
