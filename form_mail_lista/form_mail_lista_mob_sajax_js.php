  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_mail_lista_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_mail_lista_mob_form();
	}

  // ---------- Validate idmail_lista
  function do_ajax_form_mail_lista_mob_validate_idmail_lista()
  {
    var nomeCampo_idmail_lista = "idmail_lista";
    var var_idmail_lista = scAjaxGetFieldHidden(nomeCampo_idmail_lista);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_lista_mob_validate_idmail_lista(var_idmail_lista, var_script_case_init, do_ajax_form_mail_lista_mob_validate_idmail_lista_cb);
  } // do_ajax_form_mail_lista_mob_validate_idmail_lista

  function do_ajax_form_mail_lista_mob_validate_idmail_lista_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idmail_lista";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_lista_mob_validate_idmail_lista_cb

  // ---------- Validate mail_lista_descricao
  function do_ajax_form_mail_lista_mob_validate_mail_lista_descricao()
  {
    var nomeCampo_mail_lista_descricao = "mail_lista_descricao";
    var var_mail_lista_descricao = scAjaxGetFieldText(nomeCampo_mail_lista_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_lista_mob_validate_mail_lista_descricao(var_mail_lista_descricao, var_script_case_init, do_ajax_form_mail_lista_mob_validate_mail_lista_descricao_cb);
  } // do_ajax_form_mail_lista_mob_validate_mail_lista_descricao

  function do_ajax_form_mail_lista_mob_validate_mail_lista_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mail_lista_descricao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_lista_mob_validate_mail_lista_descricao_cb

  // ---------- Validate mail_lista_ativo
  function do_ajax_form_mail_lista_mob_validate_mail_lista_ativo()
  {
    var nomeCampo_mail_lista_ativo = "mail_lista_ativo";
    var var_mail_lista_ativo = scAjaxGetFieldRadio(nomeCampo_mail_lista_ativo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_lista_mob_validate_mail_lista_ativo(var_mail_lista_ativo, var_script_case_init, do_ajax_form_mail_lista_mob_validate_mail_lista_ativo_cb);
  } // do_ajax_form_mail_lista_mob_validate_mail_lista_ativo

  function do_ajax_form_mail_lista_mob_validate_mail_lista_ativo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mail_lista_ativo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_lista_mob_validate_mail_lista_ativo_cb

  // ---------- Validate status
  function do_ajax_form_mail_lista_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldHidden(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_lista_mob_validate_status(var_status, var_script_case_init, do_ajax_form_mail_lista_mob_validate_status_cb);
  } // do_ajax_form_mail_lista_mob_validate_status

  function do_ajax_form_mail_lista_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_lista_mob_validate_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_mail_lista_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_mail_lista_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idmail_lista = scAjaxGetFieldHidden("idmail_lista");
    var var_mail_lista_descricao = scAjaxGetFieldText("mail_lista_descricao");
    var var_mail_lista_ativo = scAjaxGetFieldRadio("mail_lista_ativo");
    ...
    scAjaxProcOn();
    x_ajax_form_mail_lista_mob_submit_form(var_idmail_lista, var_mail_lista_descricao, var_mail_lista_ativo, var_status, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_mail_lista_mob_submit_form_cb);
  } // do_ajax_form_mail_lista_mob_submit_form

  function do_ajax_form_mail_lista_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idmail_lista");
      scAjaxHideErrorDisplay("mail_lista_descricao");
      scAjaxHideErrorDisplay("mail_lista_ativo");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_mail_lista_mob_submit_form_cb_after_alert);
  } // do_ajax_form_mail_lista_mob_submit_form_cb
  function do_ajax_form_mail_lista_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_mail_lista_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_mail_lista_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("mail_lista_ativo");
    scAjaxHideErrorDisplay("status");
    var var_idmail_lista = document.F2.idmail_lista.value;
    ...
    scAjaxProcOn();
    x_ajax_form_mail_lista_mob_navigate_form(var_idmail_lista, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_mail_lista_mob_navigate_form_cb);
  } // do_ajax_form_mail_lista_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_lista_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_mail_lista_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idmail_lista.value = scAjaxGetKeyValue("idmail_lista");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_mail_lista_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_mail_lista_mob_navigate_form_cb
  function do_ajax_form_mail_lista_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_mail_lista_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_mail_lista_mob_navigate_form_cb_after_alert
  function sc_hide_form_mail_lista_mob_form()
  {
  ...
  ajax_field_list[0] = "idmail_lista";
  ajax_field_list[1] = "mail_lista_descricao";
  ajax_field_list[2] = "mail_lista_ativo";
  ...
  var ajax_error_list = {
    "idmail_lista": {"label": "Idmail Lista", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mail_lista_descricao": {"label": "Mail Lista Descricao", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mail_lista_ativo": {"label": "Mail Lista Ativo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "idmail_lista": new Array(),
    "mail_lista_descricao": new Array(),
    "mail_lista_ativo": new Array(),
    "status": new Array()
  };
  ajax_field_mult["idmail_lista"][1] = "idmail_lista";
  ajax_field_mult["mail_lista_descricao"][1] = "mail_lista_descricao";
  ajax_field_mult["mail_lista_ativo"][1] = "mail_lista_ativo";
  ajax_field_mult["status"][1] = "status";

  var ajax_field_id = {
    "idmail_lista": new Array("hidden_field_label_idmail_lista", "hidden_field_data_idmail_lista"),
    "mail_lista_descricao": new Array("hidden_field_label_mail_lista_descricao", "hidden_field_data_mail_lista_descricao"),
    "mail_lista_ativo": new Array("hidden_field_label_mail_lista_ativo", "hidden_field_data_mail_lista_ativo"),
    "status": new Array("hidden_field_label_status", "hidden_field_data_status")
  };

  var ajax_read_only = {
    "idmail_lista": "on",
    "mail_lista_descricao": "off",
    "mail_lista_ativo": "off",
    "status": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("mail_lista_descricao" == sIndex)
    {
