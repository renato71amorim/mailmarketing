  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_mail_lista" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_mail_lista_form();
	}

  // ---------- Validate idmail_lista
  function do_ajax_form_mail_lista_validate_idmail_lista()
  {
    var nomeCampo_idmail_lista = "idmail_lista";
    var var_idmail_lista = scAjaxGetFieldHidden(nomeCampo_idmail_lista);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_lista_validate_idmail_lista(var_idmail_lista, var_script_case_init, do_ajax_form_mail_lista_validate_idmail_lista_cb);
  } // do_ajax_form_mail_lista_validate_idmail_lista

  function do_ajax_form_mail_lista_validate_idmail_lista_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_lista_validate_idmail_lista_cb

  // ---------- Validate mail_lista_descricao
  function do_ajax_form_mail_lista_validate_mail_lista_descricao()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_lista_validate_mail_lista_descricao(var_mail_lista_descricao, var_script_case_init, do_ajax_form_mail_lista_validate_mail_lista_descricao_cb);
  } // do_ajax_form_mail_lista_validate_mail_lista_descricao

  function do_ajax_form_mail_lista_validate_mail_lista_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_lista_validate_mail_lista_descricao_cb

  // ---------- Validate mail_lista_ativo
  function do_ajax_form_mail_lista_validate_mail_lista_ativo()
  {
    var nomeCampo_mail_lista_ativo = "mail_lista_ativo";
    var var_mail_lista_ativo = scAjaxGetFieldRadio(nomeCampo_mail_lista_ativo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_lista_validate_mail_lista_ativo(var_mail_lista_ativo, var_script_case_init, do_ajax_form_mail_lista_validate_mail_lista_ativo_cb);
  } // do_ajax_form_mail_lista_validate_mail_lista_ativo

  function do_ajax_form_mail_lista_validate_mail_lista_ativo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_lista_validate_mail_lista_ativo_cb

  // ---------- Validate status
  function do_ajax_form_mail_lista_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldHidden(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_lista_validate_status(var_status, var_script_case_init, do_ajax_form_mail_lista_validate_status_cb);
  } // do_ajax_form_mail_lista_validate_status

  function do_ajax_form_mail_lista_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_lista_validate_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_mail_lista_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_mail_lista_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_mail_lista_submit_form(var_idmail_lista, var_mail_lista_descricao, var_mail_lista_ativo, var_status, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_mail_lista_submit_form_cb);
  } // do_ajax_form_mail_lista_submit_form

  function do_ajax_form_mail_lista_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_mail_lista_submit_form_cb_after_alert);
  } // do_ajax_form_mail_lista_submit_form_cb
  function do_ajax_form_mail_lista_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_mail_lista_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_mail_lista_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_mail_lista_navigate_form(var_idmail_lista, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_mail_lista_navigate_form_cb);
  } // do_ajax_form_mail_lista_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_lista']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_mail_lista_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_mail_lista_navigate_form_cb_after_alert);
  } // do_ajax_form_mail_lista_navigate_form_cb
  function do_ajax_form_mail_lista_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_mail_lista_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_mail_lista_navigate_form_cb_after_alert
  function sc_hide_form_mail_lista_form()
  {
