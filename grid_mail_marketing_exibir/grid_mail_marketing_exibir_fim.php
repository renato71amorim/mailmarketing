...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["mail_marketing_____grid_mail_marketing_exibir"]))
   {
      unset($_SESSION['session_sec_aplicacao']["mail_marketing_____grid_mail_marketing_exibir"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mail_marketing_exibir']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_mail_marketing_exibir']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mail_marketing_exibir']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_mail_marketing_exibir']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_mail_marketing_exibir']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_mail_marketing_exibir</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_mail_marketing_exibir']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_mail_marketing_exibir']['embutida_filho'] as $ind => $sc_init)
          {
