<?php
@session_start() ;
$_SESSION['scriptcase']['grid_mail_marketing_exibir']['sc_process_barr'] = true;
require_once('../grid_mail_marketing_exibir/index.php');
unset($_SESSION['scriptcase']['grid_mail_marketing_exibir']['sc_process_barr']);
$ExportCtrl = new grid_mail_marketing_exibir_export_control;
$ExportCtrl->Export_barr();

class grid_mail_marketing_exibir_export_control
{
