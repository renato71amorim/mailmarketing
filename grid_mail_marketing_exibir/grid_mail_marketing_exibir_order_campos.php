<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_mail_marketing_exibir']['glo_nm_path_imag_temp'] . "/sc_apl_default_mail_marketing.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_mail_marketing_exibir_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_mail_marketing_exibir_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['mail_marketing_assunto'] = "on";
   $tab_def_campos['mail_marketing_assunto'] = "mail_marketing_assunto";
   $tab_labels["mail_marketing_assunto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['labels']["mail_marketing_assunto"])) ? $_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['labels']["mail_marketing_assunto"] : "Mail Marketing Assunto";
   $tab_ger_campos['mail_marketing_imagem_cabecalho'] = "on";
   $tab_def_campos['mail_marketing_imagem_cabecalho'] = "mail_marketing_imagem_cabecalho";
   $tab_labels["mail_marketing_imagem_cabecalho"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['labels']["mail_marketing_imagem_cabecalho"])) ? $_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['labels']["mail_marketing_imagem_cabecalho"] : "Mail Marketing Imagem Cabecalho";
   $tab_ger_campos['mail_marketing_conteudo'] = "on";
   $tab_def_campos['mail_marketing_conteudo'] = "mail_marketing_conteudo";
   $tab_labels["mail_marketing_conteudo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['labels']["mail_marketing_conteudo"])) ? $_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['labels']["mail_marketing_conteudo"] : "Mail Marketing Conteudo";
   $tab_ger_campos['mail_marketing_link_conteudo'] = "on";
   $tab_def_campos['mail_marketing_link_conteudo'] = "mail_marketing_link_conteudo";
   $tab_labels["mail_marketing_link_conteudo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['labels']["mail_marketing_link_conteudo"])) ? $_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['labels']["mail_marketing_link_conteudo"] : "Mail Marketing Link Conteudo";
   $tab_ger_campos['mail_marketing_imagem_rodape'] = "on";
   $tab_def_campos['mail_marketing_imagem_rodape'] = "mail_marketing_imagem_rodape";
   $tab_labels["mail_marketing_imagem_rodape"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['labels']["mail_marketing_imagem_rodape"])) ? $_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['labels']["mail_marketing_imagem_rodape"] : "Mail Marketing Imagem Rodape";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_mail_marketing_exibir']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_mail_marketing_exibir']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_mail_marketing_exibir']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['ordem_quebra'] as $campo => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> mail_marketing</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_mail_marketing_exibir_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_mail_marketing_exibir']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
