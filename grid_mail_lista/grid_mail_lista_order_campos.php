...
<?php
   ...
   $Ord_Cmp = new grid_mail_lista_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_mail_lista_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_mail_lista']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_mail_lista']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idmail_lista'] = "idmail_lista";
   $tab_labels["idmail_lista"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mail_lista']['labels']["idmail_lista"])) ? $_SESSION['sc_session'][$sc_init]['grid_mail_lista']['labels']["idmail_lista"] : "Idmail Lista";
   $tab_ger_campos['mail_lista_descricao'] = "on";
   $tab_def_campos['mail_lista_descricao'] = "mail_lista_descricao";
   $tab_labels["mail_lista_descricao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mail_lista']['labels']["mail_lista_descricao"])) ? $_SESSION['sc_session'][$sc_init]['grid_mail_lista']['labels']["mail_lista_descricao"] : "Mail Lista Descricao";
   $tab_ger_campos['mail_lista_ativo'] = "on";
   $tab_def_campos['mail_lista_ativo'] = "mail_lista_ativo";
   $tab_labels["mail_lista_ativo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mail_lista']['labels']["mail_lista_ativo"])) ? $_SESSION['sc_session'][$sc_init]['grid_mail_lista']['labels']["mail_lista_ativo"] : "Mail Lista Ativo";
   $tab_ger_campos['mail_lista_sistema'] = "on";
   $tab_def_campos['mail_lista_sistema'] = "mail_lista_sistema";
   $tab_labels["mail_lista_sistema"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mail_lista']['labels']["mail_lista_sistema"])) ? $_SESSION['sc_session'][$sc_init]['grid_mail_lista']['labels']["mail_lista_sistema"] : "Mail Lista Sistema";
   $tab_ger_campos['quantregistros'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['quantregistros'] = "QuantRegistros";
   }
   else
   {
       $tab_def_campos['quantregistros'] = "";
   }
   $tab_labels["quantregistros"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mail_lista']['labels']["quantregistros"])) ? $_SESSION['sc_session'][$sc_init]['grid_mail_lista']['labels']["quantregistros"] : "Quantidade";
   $tab_ger_campos['contatos'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['contatos'] = "Contatos";
   }
   else
   {
       $tab_def_campos['contatos'] = "";
   }
   $tab_labels["contatos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mail_lista']['labels']["contatos"])) ? $_SESSION['sc_session'][$sc_init]['grid_mail_lista']['labels']["contatos"] : "Contatos";
   $tab_ger_campos['quantregistros'] = "none";
   $tab_ger_campos['contatos'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_mail_lista']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_mail_lista']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_mail_lista']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_mail_lista']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_mail_lista']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_mail_lista']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_mail_lista']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_mail_lista']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_mail_lista']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_mail_lista']['ordem_quebra'] as $campo => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_mail_lista']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_mail_lista']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_mail_lista_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_mail_lista']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_mail_lista']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_mail_lista']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_mail_lista']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_mail_lista']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
