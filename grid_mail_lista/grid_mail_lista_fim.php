...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["mail_marketing_____grid_mail_lista"]))
   {
      unset($_SESSION['session_sec_aplicacao']["mail_marketing_____grid_mail_lista"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_mail_lista'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mail_lista']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_mail_lista']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mail_lista']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_mail_lista']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_mail_lista']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_mail_lista']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_mail_lista']['embutida_filho'] as $ind => $sc_init)
          {
