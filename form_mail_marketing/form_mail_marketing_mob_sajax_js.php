  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_mail_marketing_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_mail_marketing_mob_validate_idmail_marketing()
  {
    ...
    x_ajax_form_mail_marketing_mob_validate_idmail_marketing(var_idmail_marketing, var_script_case_init, do_ajax_form_mail_marketing_mob_validate_idmail_marketing_cb);
  } // do_ajax_form_mail_marketing_mob_validate_idmail_marketing

  function do_ajax_form_mail_marketing_mob_validate_idmail_marketing_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_marketing_mob_validate_idmail_marketing_cb

  // ---------- Validate mail_marketing_campanha
  function do_ajax_form_mail_marketing_mob_validate_mail_marketing_campanha()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_marketing_mob_validate_mail_marketing_campanha(var_mail_marketing_campanha, var_script_case_init, do_ajax_form_mail_marketing_mob_validate_mail_marketing_campanha_cb);
  } // do_ajax_form_mail_marketing_mob_validate_mail_marketing_campanha

  function do_ajax_form_mail_marketing_mob_validate_mail_marketing_campanha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_marketing_mob_validate_mail_marketing_campanha_cb

  // ---------- Validate mail_marketing_emitente
  function do_ajax_form_mail_marketing_mob_validate_mail_marketing_emitente()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_marketing_mob_validate_mail_marketing_emitente(var_mail_marketing_emitente, var_script_case_init, do_ajax_form_mail_marketing_mob_validate_mail_marketing_emitente_cb);
  } // do_ajax_form_mail_marketing_mob_validate_mail_marketing_emitente

  function do_ajax_form_mail_marketing_mob_validate_mail_marketing_emitente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_marketing_mob_validate_mail_marketing_emitente_cb

  // ---------- Validate mail_marketing_lista
  function do_ajax_form_mail_marketing_mob_validate_mail_marketing_lista()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_marketing_mob_validate_mail_marketing_lista(var_mail_marketing_lista, var_script_case_init, do_ajax_form_mail_marketing_mob_validate_mail_marketing_lista_cb);
  } // do_ajax_form_mail_marketing_mob_validate_mail_marketing_lista

  function do_ajax_form_mail_marketing_mob_validate_mail_marketing_lista_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_marketing_mob_validate_mail_marketing_lista_cb

  // ---------- Validate mail_marketing_assunto
  function do_ajax_form_mail_marketing_mob_validate_mail_marketing_assunto()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_marketing_mob_validate_mail_marketing_assunto(var_mail_marketing_assunto, var_script_case_init, do_ajax_form_mail_marketing_mob_validate_mail_marketing_assunto_cb);
  } // do_ajax_form_mail_marketing_mob_validate_mail_marketing_assunto

  function do_ajax_form_mail_marketing_mob_validate_mail_marketing_assunto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_marketing_mob_validate_mail_marketing_assunto_cb

  // ---------- Validate mail_marketing_imagem_cabecalho
  function do_ajax_form_mail_marketing_mob_validate_mail_marketing_imagem_cabecalho()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_marketing_mob_validate_mail_marketing_imagem_cabecalho(var_mail_marketing_imagem_cabecalho, var_script_case_init, do_ajax_form_mail_marketing_mob_validate_mail_marketing_imagem_cabecalho_cb);
  } // do_ajax_form_mail_marketing_mob_validate_mail_marketing_imagem_cabecalho

  function do_ajax_form_mail_marketing_mob_validate_mail_marketing_imagem_cabecalho_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_marketing_mob_validate_mail_marketing_imagem_cabecalho_cb

  // ---------- Validate mail_marketing_conteudo
  function do_ajax_form_mail_marketing_mob_validate_mail_marketing_conteudo()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_marketing_mob_validate_mail_marketing_conteudo(var_mail_marketing_conteudo, var_script_case_init, do_ajax_form_mail_marketing_mob_validate_mail_marketing_conteudo_cb);
  } // do_ajax_form_mail_marketing_mob_validate_mail_marketing_conteudo

  function do_ajax_form_mail_marketing_mob_validate_mail_marketing_conteudo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_marketing_mob_validate_mail_marketing_conteudo_cb

  // ---------- Validate mail_marketing_link_conteudo
  function do_ajax_form_mail_marketing_mob_validate_mail_marketing_link_conteudo()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_marketing_mob_validate_mail_marketing_link_conteudo(var_mail_marketing_link_conteudo, var_script_case_init, do_ajax_form_mail_marketing_mob_validate_mail_marketing_link_conteudo_cb);
  } // do_ajax_form_mail_marketing_mob_validate_mail_marketing_link_conteudo

  function do_ajax_form_mail_marketing_mob_validate_mail_marketing_link_conteudo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_marketing_mob_validate_mail_marketing_link_conteudo_cb

  // ---------- Validate mail_marketing_imagem_rodape
  function do_ajax_form_mail_marketing_mob_validate_mail_marketing_imagem_rodape()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_marketing_mob_validate_mail_marketing_imagem_rodape(var_mail_marketing_imagem_rodape, var_script_case_init, do_ajax_form_mail_marketing_mob_validate_mail_marketing_imagem_rodape_cb);
  } // do_ajax_form_mail_marketing_mob_validate_mail_marketing_imagem_rodape

  function do_ajax_form_mail_marketing_mob_validate_mail_marketing_imagem_rodape_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_marketing_mob_validate_mail_marketing_imagem_rodape_cb
  ...
  function do_ajax_form_mail_marketing_mob_validate_mail_marketing_iniciar_quando_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_marketing_mob_validate_mail_marketing_iniciar_quando_cb
  ...
  function do_ajax_form_mail_marketing_mob_validate_mail_marketing_terminar_quando_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_mail_marketing_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_mail_marketing_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_mail_marketing_mob_submit_form_cb_after_alert);
  } // do_ajax_form_mail_marketing_mob_submit_form_cb
  function do_ajax_form_mail_marketing_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_mail_marketing_mob_submit_form_cb_after_alert
  ...
  function do_ajax_form_mail_marketing_mob_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_mail_marketing_mob_navigate_form(var_idmail_marketing, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_mail_marketing_mob_navigate_form_cb);
  } // do_ajax_form_mail_marketing_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_mail_marketing_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_mail_marketing_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_mail_marketing_mob_navigate_form_cb
...
{
?>
    do_ajax_form_mail_marketing_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
