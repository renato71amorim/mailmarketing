...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_mail_marketing_iniciar_quando_hora' + iSeqRow).bind('blur', function() { sc_form_mail_marketing_mail_marketing_iniciar_quando_onblur(this, iSeqRow) })
                                                                .bind('focus', function() { sc_form_mail_marketing_mail_marketing_iniciar_quando_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_mail_marketing_terminar_quando_hora' + iSeqRow).bind('blur', function() { sc_form_mail_marketing_mail_marketing_terminar_quando_onblur(this, iSeqRow) })
                                                                 .bind('focus', function() { sc_form_mail_marketing_mail_marketing_terminar_quando_onfocus(this, iSeqRow) });
} // scJQEventsAdd
...
function scHidePage(pageNo) {
	$("#id_form_mail_marketing_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_mail_marketing_iniciar_quando" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_mail_marketing_mob_validate_mail_marketing_iniciar_quando(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_mail_marketing_terminar_quando" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_mail_marketing_mob_validate_mail_marketing_terminar_quando(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_mail_marketing_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
