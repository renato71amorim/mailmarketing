...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_mail_marketing_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_mail_marketing_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['recarga']))
{
...
<?php
 include_once("form_mail_marketing_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_mail_marketing'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_mail_marketing'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_mail_marketing_imagem_cabecalho_label" id="hidden_field_label_mail_marketing_imagem_cabecalho" style="<?php echo $sStyleHidden_mail_marketing_imagem_cabecalho; ?>"><span id="id_label_mail_marketing_imagem_cabecalho"><?php echo $this->nm_new_label['mail_marketing_imagem_cabecalho']; ?></span></TD>
    <TD class="scFormDataOdd css_mail_marketing_imagem_cabecalho_line" id="hidden_field_data_mail_marketing_imagem_cabecalho" style="<?php echo $sStyleHidden_mail_marketing_imagem_cabecalho; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mail_marketing_imagem_cabecalho_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_mail_marketing_conteudo_label" id="hidden_field_label_mail_marketing_conteudo" style="<?php echo $sStyleHidden_mail_marketing_conteudo; ?>"><span id="id_label_mail_marketing_conteudo"><?php echo $this->nm_new_label['mail_marketing_conteudo']; ?></span></TD>
    <TD class="scFormDataOdd css_mail_marketing_conteudo_line" id="hidden_field_data_mail_marketing_conteudo" style="<?php echo $sStyleHidden_mail_marketing_conteudo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mail_marketing_conteudo_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_mail_marketing_link_conteudo_label" id="hidden_field_label_mail_marketing_link_conteudo" style="<?php echo $sStyleHidden_mail_marketing_link_conteudo; ?>"><span id="id_label_mail_marketing_link_conteudo"><?php echo $this->nm_new_label['mail_marketing_link_conteudo']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_mail_marketing_imagem_rodape_label" id="hidden_field_label_mail_marketing_imagem_rodape" style="<?php echo $sStyleHidden_mail_marketing_imagem_rodape; ?>"><span id="id_label_mail_marketing_imagem_rodape"><?php echo $this->nm_new_label['mail_marketing_imagem_rodape']; ?></span></TD>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_mail_marketing");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_mail_marketing");
 parent.scAjaxDetailHeight("form_mail_marketing", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
