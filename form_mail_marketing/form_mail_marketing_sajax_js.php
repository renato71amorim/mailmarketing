  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_mail_marketing" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_mail_marketing_form();
	}

  // ---------- Validate idmail_marketing
  function do_ajax_form_mail_marketing_validate_idmail_marketing()
  {
    var nomeCampo_idmail_marketing = "idmail_marketing";
    var var_idmail_marketing = scAjaxGetFieldHidden(nomeCampo_idmail_marketing);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_marketing_validate_idmail_marketing(var_idmail_marketing, var_script_case_init, do_ajax_form_mail_marketing_validate_idmail_marketing_cb);
  } // do_ajax_form_mail_marketing_validate_idmail_marketing

  function do_ajax_form_mail_marketing_validate_idmail_marketing_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idmail_marketing";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_marketing_validate_idmail_marketing_cb

  // ---------- Validate mail_marketing_campanha
  function do_ajax_form_mail_marketing_validate_mail_marketing_campanha()
  {
    var nomeCampo_mail_marketing_campanha = "mail_marketing_campanha";
    var var_mail_marketing_campanha = scAjaxGetFieldText(nomeCampo_mail_marketing_campanha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_marketing_validate_mail_marketing_campanha(var_mail_marketing_campanha, var_script_case_init, do_ajax_form_mail_marketing_validate_mail_marketing_campanha_cb);
  } // do_ajax_form_mail_marketing_validate_mail_marketing_campanha

  function do_ajax_form_mail_marketing_validate_mail_marketing_campanha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mail_marketing_campanha";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_marketing_validate_mail_marketing_campanha_cb

  // ---------- Validate mail_marketing_emitente
  function do_ajax_form_mail_marketing_validate_mail_marketing_emitente()
  {
    var nomeCampo_mail_marketing_emitente = "mail_marketing_emitente";
    var var_mail_marketing_emitente = scAjaxGetFieldRadio(nomeCampo_mail_marketing_emitente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_marketing_validate_mail_marketing_emitente(var_mail_marketing_emitente, var_script_case_init, do_ajax_form_mail_marketing_validate_mail_marketing_emitente_cb);
  } // do_ajax_form_mail_marketing_validate_mail_marketing_emitente

  function do_ajax_form_mail_marketing_validate_mail_marketing_emitente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mail_marketing_emitente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_marketing_validate_mail_marketing_emitente_cb

  // ---------- Validate mail_marketing_lista
  function do_ajax_form_mail_marketing_validate_mail_marketing_lista()
  {
    var nomeCampo_mail_marketing_lista = "mail_marketing_lista";
    var var_mail_marketing_lista = scAjaxGetFieldSelect(nomeCampo_mail_marketing_lista);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_marketing_validate_mail_marketing_lista(var_mail_marketing_lista, var_script_case_init, do_ajax_form_mail_marketing_validate_mail_marketing_lista_cb);
  } // do_ajax_form_mail_marketing_validate_mail_marketing_lista

  function do_ajax_form_mail_marketing_validate_mail_marketing_lista_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mail_marketing_lista";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_marketing_validate_mail_marketing_lista_cb

  // ---------- Validate mail_marketing_assunto
  function do_ajax_form_mail_marketing_validate_mail_marketing_assunto()
  {
    var nomeCampo_mail_marketing_assunto = "mail_marketing_assunto";
    var var_mail_marketing_assunto = scAjaxGetFieldText(nomeCampo_mail_marketing_assunto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_marketing_validate_mail_marketing_assunto(var_mail_marketing_assunto, var_script_case_init, do_ajax_form_mail_marketing_validate_mail_marketing_assunto_cb);
  } // do_ajax_form_mail_marketing_validate_mail_marketing_assunto

  function do_ajax_form_mail_marketing_validate_mail_marketing_assunto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mail_marketing_assunto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_marketing_validate_mail_marketing_assunto_cb

  // ---------- Validate mail_marketing_imagem_cabecalho
  function do_ajax_form_mail_marketing_validate_mail_marketing_imagem_cabecalho()
  {
    var nomeCampo_mail_marketing_imagem_cabecalho = "mail_marketing_imagem_cabecalho";
    var var_mail_marketing_imagem_cabecalho = scAjaxGetFieldText(nomeCampo_mail_marketing_imagem_cabecalho);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_marketing_validate_mail_marketing_imagem_cabecalho(var_mail_marketing_imagem_cabecalho, var_script_case_init, do_ajax_form_mail_marketing_validate_mail_marketing_imagem_cabecalho_cb);
  } // do_ajax_form_mail_marketing_validate_mail_marketing_imagem_cabecalho

  function do_ajax_form_mail_marketing_validate_mail_marketing_imagem_cabecalho_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mail_marketing_imagem_cabecalho";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_marketing_validate_mail_marketing_imagem_cabecalho_cb

  // ---------- Validate mail_marketing_conteudo
  function do_ajax_form_mail_marketing_validate_mail_marketing_conteudo()
  {
    var nomeCampo_mail_marketing_conteudo = "mail_marketing_conteudo";
    var var_mail_marketing_conteudo = scAjaxGetFieldText(nomeCampo_mail_marketing_conteudo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_marketing_validate_mail_marketing_conteudo(var_mail_marketing_conteudo, var_script_case_init, do_ajax_form_mail_marketing_validate_mail_marketing_conteudo_cb);
  } // do_ajax_form_mail_marketing_validate_mail_marketing_conteudo

  function do_ajax_form_mail_marketing_validate_mail_marketing_conteudo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mail_marketing_conteudo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_marketing_validate_mail_marketing_conteudo_cb

  // ---------- Validate mail_marketing_link_conteudo
  function do_ajax_form_mail_marketing_validate_mail_marketing_link_conteudo()
  {
    var nomeCampo_mail_marketing_link_conteudo = "mail_marketing_link_conteudo";
    var var_mail_marketing_link_conteudo = scAjaxGetFieldText(nomeCampo_mail_marketing_link_conteudo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_marketing_validate_mail_marketing_link_conteudo(var_mail_marketing_link_conteudo, var_script_case_init, do_ajax_form_mail_marketing_validate_mail_marketing_link_conteudo_cb);
  } // do_ajax_form_mail_marketing_validate_mail_marketing_link_conteudo

  function do_ajax_form_mail_marketing_validate_mail_marketing_link_conteudo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mail_marketing_link_conteudo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_marketing_validate_mail_marketing_link_conteudo_cb

  // ---------- Validate mail_marketing_imagem_rodape
  function do_ajax_form_mail_marketing_validate_mail_marketing_imagem_rodape()
  {
    var nomeCampo_mail_marketing_imagem_rodape = "mail_marketing_imagem_rodape";
    var var_mail_marketing_imagem_rodape = scAjaxGetFieldText(nomeCampo_mail_marketing_imagem_rodape);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_marketing_validate_mail_marketing_imagem_rodape(var_mail_marketing_imagem_rodape, var_script_case_init, do_ajax_form_mail_marketing_validate_mail_marketing_imagem_rodape_cb);
  } // do_ajax_form_mail_marketing_validate_mail_marketing_imagem_rodape

  function do_ajax_form_mail_marketing_validate_mail_marketing_imagem_rodape_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mail_marketing_imagem_rodape";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_marketing_validate_mail_marketing_imagem_rodape_cb

  // ---------- Validate mail_marketing_iniciar_quando
  function do_ajax_form_mail_marketing_validate_mail_marketing_iniciar_quando()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_marketing_validate_mail_marketing_iniciar_quando(var_mail_marketing_iniciar_quando, var_script_case_init, do_ajax_form_mail_marketing_validate_mail_marketing_iniciar_quando_cb);
  } // do_ajax_form_mail_marketing_validate_mail_marketing_iniciar_quando

  function do_ajax_form_mail_marketing_validate_mail_marketing_iniciar_quando_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mail_marketing_iniciar_quando";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_marketing_validate_mail_marketing_iniciar_quando_cb

  // ---------- Validate mail_marketing_terminar_quando
  function do_ajax_form_mail_marketing_validate_mail_marketing_terminar_quando()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_marketing_validate_mail_marketing_terminar_quando(var_mail_marketing_terminar_quando, var_script_case_init, do_ajax_form_mail_marketing_validate_mail_marketing_terminar_quando_cb);
  } // do_ajax_form_mail_marketing_validate_mail_marketing_terminar_quando

  function do_ajax_form_mail_marketing_validate_mail_marketing_terminar_quando_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mail_marketing_terminar_quando";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_marketing_validate_mail_marketing_terminar_quando_cb

  // ---------- Validate mail_marketing_gatilho
  function do_ajax_form_mail_marketing_validate_mail_marketing_gatilho()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_marketing_validate_mail_marketing_gatilho(var_mail_marketing_gatilho, var_script_case_init, do_ajax_form_mail_marketing_validate_mail_marketing_gatilho_cb);
  } // do_ajax_form_mail_marketing_validate_mail_marketing_gatilho

  function do_ajax_form_mail_marketing_validate_mail_marketing_gatilho_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_marketing_validate_mail_marketing_gatilho_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_mail_marketing_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_mail_marketing_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idmail_marketing = scAjaxGetFieldHidden("idmail_marketing");
    var var_mail_marketing_campanha = scAjaxGetFieldText("mail_marketing_campanha");
    var var_mail_marketing_emitente = scAjaxGetFieldRadio("mail_marketing_emitente");
    var var_mail_marketing_lista = scAjaxGetFieldSelect("mail_marketing_lista");
    var var_mail_marketing_assunto = scAjaxGetFieldText("mail_marketing_assunto");
    var var_mail_marketing_imagem_cabecalho = scAjaxGetFieldText("mail_marketing_imagem_cabecalho");
    ...
    scAjaxProcOn();
    x_ajax_form_mail_marketing_submit_form(var_idmail_marketing, var_mail_marketing_campanha, var_mail_marketing_emitente, var_mail_marketing_lista, var_mail_marketing_assunto, var_mail_marketing_imagem_cabecalho, var_mail_marketing_conteudo, var_mail_marketing_link_conteudo, var_mail_marketing_imagem_rodape, var_mail_marketing_iniciar_quando, var_mail_marketing_terminar_quando, var_mail_marketing_gatilho, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_mail_marketing_submit_form_cb);
  } // do_ajax_form_mail_marketing_submit_form

  function do_ajax_form_mail_marketing_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("mail_marketing_campanha");
      scAjaxHideErrorDisplay("mail_marketing_emitente");
      scAjaxHideErrorDisplay("mail_marketing_lista");
      scAjaxHideErrorDisplay("mail_marketing_assunto");
      scAjaxHideErrorDisplay("mail_marketing_imagem_cabecalho");
      scAjaxHideErrorDisplay("mail_marketing_conteudo");
      scAjaxHideErrorDisplay("mail_marketing_link_conteudo");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_mail_marketing_submit_form_cb_after_alert);
  } // do_ajax_form_mail_marketing_submit_form_cb
  function do_ajax_form_mail_marketing_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_mail_marketing_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_mail_marketing_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_mail_marketing_navigate_form(var_idmail_marketing, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_mail_marketing_navigate_form_cb);
  } // do_ajax_form_mail_marketing_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_marketing']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_mail_marketing_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_mail_marketing_navigate_form_cb_after_alert);
  } // do_ajax_form_mail_marketing_navigate_form_cb
  function do_ajax_form_mail_marketing_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_mail_marketing_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_mail_marketing_navigate_form_cb_after_alert
  function sc_hide_form_mail_marketing_form()
  {
  ...
  ajax_field_list[0] = "idmail_marketing";
  ajax_field_list[1] = "mail_marketing_campanha";
  ajax_field_list[2] = "mail_marketing_emitente";
  ajax_field_list[3] = "mail_marketing_lista";
  ajax_field_list[4] = "mail_marketing_assunto";
  ajax_field_list[5] = "mail_marketing_imagem_cabecalho";
  ajax_field_list[6] = "mail_marketing_conteudo";
  ajax_field_list[7] = "mail_marketing_link_conteudo";
  ...
  var ajax_error_list = {
    ...
    "mail_marketing_campanha": {"label": "Mail Marketing Campanha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mail_marketing_emitente": {"label": "Mail Marketing Emitente", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mail_marketing_lista": {"label": "Mail Marketing Lista", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mail_marketing_assunto": {"label": "Mail Marketing Assunto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mail_marketing_imagem_cabecalho": {"label": "Mail Marketing Imagem Cabecalho", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mail_marketing_conteudo": {"label": "Mail Marketing Conteudo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "idmail_marketing": new Array(),
    "mail_marketing_campanha": new Array(),
    "mail_marketing_emitente": new Array(),
    "mail_marketing_lista": new Array(),
    "mail_marketing_assunto": new Array(),
    "mail_marketing_imagem_cabecalho": new Array(),
    "mail_marketing_conteudo": new Array(),
  ...
  ajax_field_mult["mail_marketing_emitente"][1] = "mail_marketing_emitente";
  ajax_field_mult["mail_marketing_lista"][1] = "mail_marketing_lista";
  ajax_field_mult["mail_marketing_assunto"][1] = "mail_marketing_assunto";
  ajax_field_mult["mail_marketing_imagem_cabecalho"][1] = "mail_marketing_imagem_cabecalho";
  ajax_field_mult["mail_marketing_conteudo"][1] = "mail_marketing_conteudo";
  ajax_field_mult["mail_marketing_link_conteudo"][1] = "mail_marketing_link_conteudo";
  ...
  var ajax_field_id = {
    ...
    "mail_marketing_campanha": new Array("hidden_field_label_mail_marketing_campanha", "hidden_field_data_mail_marketing_campanha"),
    "mail_marketing_emitente": new Array("hidden_field_label_mail_marketing_emitente", "hidden_field_data_mail_marketing_emitente"),
    "mail_marketing_lista": new Array("hidden_field_label_mail_marketing_lista", "hidden_field_data_mail_marketing_lista"),
    "mail_marketing_assunto": new Array("hidden_field_label_mail_marketing_assunto", "hidden_field_data_mail_marketing_assunto"),
    "mail_marketing_imagem_cabecalho": new Array("hidden_field_label_mail_marketing_imagem_cabecalho", "hidden_field_data_mail_marketing_imagem_cabecalho"),
    "mail_marketing_conteudo": new Array("hidden_field_label_mail_marketing_conteudo", "hidden_field_data_mail_marketing_conteudo"),
  ...
  var ajax_read_only = {
    "idmail_marketing": "on",
    "mail_marketing_campanha": "off",
    "mail_marketing_emitente": "off",
    "mail_marketing_lista": "off",
    "mail_marketing_assunto": "off",
    "mail_marketing_imagem_cabecalho": "off",
    "mail_marketing_conteudo": "off",
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("mail_marketing_campanha" == sIndex)
    {
    ...
    if ("mail_marketing_emitente" == sIndex)
    {
    ...
    if ("mail_marketing_lista" == sIndex)
    {
    ...
    if ("mail_marketing_assunto" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("mail_marketing_imagem_cabecalho" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("mail_marketing_conteudo" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("mail_marketing_link_conteudo" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("mail_marketing_imagem_rodape" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
