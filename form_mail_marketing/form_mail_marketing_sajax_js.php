...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_mail_marketing_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_mail_marketing_submit_form(var_idmail_marketing, var_mail_marketing_campanha, var_mail_marketing_emitente, var_mail_marketing_lista, var_mail_marketing_assunto, var_mail_marketing_imagem_cabecalho, var_mail_marketing_conteudo, var_mail_marketing_link_conteudo, var_mail_marketing_imagem_rodape, var_mail_marketing_iniciar_quando, var_mail_marketing_terminar_quando, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_mail_marketing_submit_form_cb);
...
?>
  ...
  {
    perform_ajax_form_mail_marketing_navigate_form();
  }

  function perform_ajax_form_mail_marketing_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
