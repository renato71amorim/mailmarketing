  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_mail_meio" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_mail_meio_validate_idmail_meio()
  {
    ...
    x_ajax_form_mail_meio_validate_idmail_meio(var_idmail_meio, var_script_case_init, do_ajax_form_mail_meio_validate_idmail_meio_cb);
  } // do_ajax_form_mail_meio_validate_idmail_meio

  function do_ajax_form_mail_meio_validate_idmail_meio_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_meio_validate_idmail_meio_cb

  // ---------- Validate mail_descreva
  function do_ajax_form_mail_meio_validate_mail_descreva()
  {
    var nomeCampo_mail_descreva = "mail_descreva";
    var var_mail_descreva = scAjaxGetFieldText(nomeCampo_mail_descreva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_meio_validate_mail_descreva(var_mail_descreva, var_script_case_init, do_ajax_form_mail_meio_validate_mail_descreva_cb);
  } // do_ajax_form_mail_meio_validate_mail_descreva

  function do_ajax_form_mail_meio_validate_mail_descreva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_meio_validate_mail_descreva_cb

  // ---------- Validate mail_usuario
  function do_ajax_form_mail_meio_validate_mail_usuario()
  {
    var nomeCampo_mail_usuario = "mail_usuario";
    var var_mail_usuario = scAjaxGetFieldText(nomeCampo_mail_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_meio_validate_mail_usuario(var_mail_usuario, var_script_case_init, do_ajax_form_mail_meio_validate_mail_usuario_cb);
  } // do_ajax_form_mail_meio_validate_mail_usuario

  function do_ajax_form_mail_meio_validate_mail_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_meio_validate_mail_usuario_cb

  // ---------- Validate mail_senha
  function do_ajax_form_mail_meio_validate_mail_senha()
  {
    var nomeCampo_mail_senha = "mail_senha";
    var var_mail_senha = scAjaxGetFieldText(nomeCampo_mail_senha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_meio_validate_mail_senha(var_mail_senha, var_script_case_init, do_ajax_form_mail_meio_validate_mail_senha_cb);
  } // do_ajax_form_mail_meio_validate_mail_senha

  function do_ajax_form_mail_meio_validate_mail_senha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_meio_validate_mail_senha_cb

  // ---------- Validate mail_smtp
  function do_ajax_form_mail_meio_validate_mail_smtp()
  {
    var nomeCampo_mail_smtp = "mail_smtp";
    var var_mail_smtp = scAjaxGetFieldText(nomeCampo_mail_smtp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_meio_validate_mail_smtp(var_mail_smtp, var_script_case_init, do_ajax_form_mail_meio_validate_mail_smtp_cb);
  } // do_ajax_form_mail_meio_validate_mail_smtp

  function do_ajax_form_mail_meio_validate_mail_smtp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_meio_validate_mail_smtp_cb

  // ---------- Validate mail_porta
  function do_ajax_form_mail_meio_validate_mail_porta()
  {
    var nomeCampo_mail_porta = "mail_porta";
    var var_mail_porta = scAjaxGetFieldText(nomeCampo_mail_porta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_meio_validate_mail_porta(var_mail_porta, var_script_case_init, do_ajax_form_mail_meio_validate_mail_porta_cb);
  } // do_ajax_form_mail_meio_validate_mail_porta

  function do_ajax_form_mail_meio_validate_mail_porta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_meio_validate_mail_porta_cb

  // ---------- Validate mail_seguranca
  function do_ajax_form_mail_meio_validate_mail_seguranca()
  {
    var nomeCampo_mail_seguranca = "mail_seguranca";
    var var_mail_seguranca = scAjaxGetFieldText(nomeCampo_mail_seguranca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_meio_validate_mail_seguranca(var_mail_seguranca, var_script_case_init, do_ajax_form_mail_meio_validate_mail_seguranca_cb);
  } // do_ajax_form_mail_meio_validate_mail_seguranca

  function do_ajax_form_mail_meio_validate_mail_seguranca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_meio_validate_mail_seguranca_cb

  // ---------- Validate mail_ativo
  function do_ajax_form_mail_meio_validate_mail_ativo()
  {
    var nomeCampo_mail_ativo = "mail_ativo";
    var var_mail_ativo = scAjaxGetFieldText(nomeCampo_mail_ativo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_meio_validate_mail_ativo(var_mail_ativo, var_script_case_init, do_ajax_form_mail_meio_validate_mail_ativo_cb);
  } // do_ajax_form_mail_meio_validate_mail_ativo

  function do_ajax_form_mail_meio_validate_mail_ativo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_meio_validate_mail_ativo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_mail_meio_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_mail_meio_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_mail_meio_submit_form(var_idmail_meio, var_mail_descreva, var_mail_usuario, var_mail_senha, var_mail_smtp, var_mail_porta, var_mail_seguranca, var_mail_ativo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_mail_meio_submit_form_cb);
  } // do_ajax_form_mail_meio_submit_form

  function do_ajax_form_mail_meio_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_mail_meio_submit_form_cb_after_alert);
  } // do_ajax_form_mail_meio_submit_form_cb
  function do_ajax_form_mail_meio_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_mail_meio_submit_form_cb_after_alert
  ...
  function do_ajax_form_mail_meio_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_mail_meio_navigate_form(var_idmail_meio, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_mail_meio_navigate_form_cb);
  } // do_ajax_form_mail_meio_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_meio']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_mail_meio_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_mail_meio_navigate_form_cb_after_alert);
  } // do_ajax_form_mail_meio_navigate_form_cb
...
{
?>
    do_ajax_form_mail_meio_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_mail_meio_navigate_form_cb_after_alert
  function sc_hide_form_mail_meio_form()
  {
