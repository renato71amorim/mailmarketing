  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_mail_meio_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_mail_meio_mob_form();
	}
  ...
  function do_ajax_form_mail_meio_mob_validate_idmail_meio()
  {
    var nomeCampo_idmail_meio = "idmail_meio";
    var var_idmail_meio = scAjaxGetFieldHidden(nomeCampo_idmail_meio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_meio_mob_validate_idmail_meio(var_idmail_meio, var_script_case_init, do_ajax_form_mail_meio_mob_validate_idmail_meio_cb);
  } // do_ajax_form_mail_meio_mob_validate_idmail_meio

  function do_ajax_form_mail_meio_mob_validate_idmail_meio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idmail_meio";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_meio_mob_validate_idmail_meio_cb

  // ---------- Validate mail_descreva
  function do_ajax_form_mail_meio_mob_validate_mail_descreva()
  {
    var nomeCampo_mail_descreva = "mail_descreva";
    var var_mail_descreva = scAjaxGetFieldText(nomeCampo_mail_descreva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_meio_mob_validate_mail_descreva(var_mail_descreva, var_script_case_init, do_ajax_form_mail_meio_mob_validate_mail_descreva_cb);
  } // do_ajax_form_mail_meio_mob_validate_mail_descreva

  function do_ajax_form_mail_meio_mob_validate_mail_descreva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mail_descreva";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_meio_mob_validate_mail_descreva_cb

  // ---------- Validate mail_usuario
  function do_ajax_form_mail_meio_mob_validate_mail_usuario()
  {
    var nomeCampo_mail_usuario = "mail_usuario";
    var var_mail_usuario = scAjaxGetFieldText(nomeCampo_mail_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_meio_mob_validate_mail_usuario(var_mail_usuario, var_script_case_init, do_ajax_form_mail_meio_mob_validate_mail_usuario_cb);
  } // do_ajax_form_mail_meio_mob_validate_mail_usuario

  function do_ajax_form_mail_meio_mob_validate_mail_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mail_usuario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_meio_mob_validate_mail_usuario_cb

  // ---------- Validate mail_senha
  function do_ajax_form_mail_meio_mob_validate_mail_senha()
  {
    var nomeCampo_mail_senha = "mail_senha";
    var var_mail_senha = scAjaxGetFieldText(nomeCampo_mail_senha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_meio_mob_validate_mail_senha(var_mail_senha, var_script_case_init, do_ajax_form_mail_meio_mob_validate_mail_senha_cb);
  } // do_ajax_form_mail_meio_mob_validate_mail_senha

  function do_ajax_form_mail_meio_mob_validate_mail_senha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mail_senha";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_meio_mob_validate_mail_senha_cb

  // ---------- Validate mail_smtp
  function do_ajax_form_mail_meio_mob_validate_mail_smtp()
  {
    var nomeCampo_mail_smtp = "mail_smtp";
    var var_mail_smtp = scAjaxGetFieldText(nomeCampo_mail_smtp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_meio_mob_validate_mail_smtp(var_mail_smtp, var_script_case_init, do_ajax_form_mail_meio_mob_validate_mail_smtp_cb);
  } // do_ajax_form_mail_meio_mob_validate_mail_smtp

  function do_ajax_form_mail_meio_mob_validate_mail_smtp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mail_smtp";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_meio_mob_validate_mail_smtp_cb

  // ---------- Validate mail_porta
  function do_ajax_form_mail_meio_mob_validate_mail_porta()
  {
    var nomeCampo_mail_porta = "mail_porta";
    var var_mail_porta = scAjaxGetFieldText(nomeCampo_mail_porta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_meio_mob_validate_mail_porta(var_mail_porta, var_script_case_init, do_ajax_form_mail_meio_mob_validate_mail_porta_cb);
  } // do_ajax_form_mail_meio_mob_validate_mail_porta

  function do_ajax_form_mail_meio_mob_validate_mail_porta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mail_porta";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_meio_mob_validate_mail_porta_cb

  // ---------- Validate mail_seguranca
  function do_ajax_form_mail_meio_mob_validate_mail_seguranca()
  {
    var nomeCampo_mail_seguranca = "mail_seguranca";
    var var_mail_seguranca = scAjaxGetFieldText(nomeCampo_mail_seguranca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_meio_mob_validate_mail_seguranca(var_mail_seguranca, var_script_case_init, do_ajax_form_mail_meio_mob_validate_mail_seguranca_cb);
  } // do_ajax_form_mail_meio_mob_validate_mail_seguranca

  function do_ajax_form_mail_meio_mob_validate_mail_seguranca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mail_seguranca";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_meio_mob_validate_mail_seguranca_cb

  // ---------- Validate mail_ativo
  function do_ajax_form_mail_meio_mob_validate_mail_ativo()
  {
    var nomeCampo_mail_ativo = "mail_ativo";
    var var_mail_ativo = scAjaxGetFieldText(nomeCampo_mail_ativo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_meio_mob_validate_mail_ativo(var_mail_ativo, var_script_case_init, do_ajax_form_mail_meio_mob_validate_mail_ativo_cb);
  } // do_ajax_form_mail_meio_mob_validate_mail_ativo

  function do_ajax_form_mail_meio_mob_validate_mail_ativo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mail_ativo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_meio_mob_validate_mail_ativo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_mail_meio_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_mail_meio_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idmail_meio = scAjaxGetFieldHidden("idmail_meio");
    var var_mail_descreva = scAjaxGetFieldText("mail_descreva");
    var var_mail_usuario = scAjaxGetFieldText("mail_usuario");
    var var_mail_senha = scAjaxGetFieldText("mail_senha");
    var var_mail_smtp = scAjaxGetFieldText("mail_smtp");
    var var_mail_porta = scAjaxGetFieldText("mail_porta");
    var var_mail_seguranca = scAjaxGetFieldText("mail_seguranca");
    var var_mail_ativo = scAjaxGetFieldText("mail_ativo");
    ...
    scAjaxProcOn();
    x_ajax_form_mail_meio_mob_submit_form(var_idmail_meio, var_mail_descreva, var_mail_usuario, var_mail_senha, var_mail_smtp, var_mail_porta, var_mail_seguranca, var_mail_ativo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_mail_meio_mob_submit_form_cb);
  } // do_ajax_form_mail_meio_mob_submit_form

  function do_ajax_form_mail_meio_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("mail_descreva");
      scAjaxHideErrorDisplay("mail_usuario");
      scAjaxHideErrorDisplay("mail_senha");
      scAjaxHideErrorDisplay("mail_smtp");
      scAjaxHideErrorDisplay("mail_porta");
      scAjaxHideErrorDisplay("mail_seguranca");
      scAjaxHideErrorDisplay("mail_ativo");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_mail_meio_mob_submit_form_cb_after_alert);
  } // do_ajax_form_mail_meio_mob_submit_form_cb
  function do_ajax_form_mail_meio_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_mail_meio_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_mail_meio_mob_navigate_form()
  {
    perform_ajax_form_mail_meio_mob_navigate_form();
  }

  function perform_ajax_form_mail_meio_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("mail_seguranca");
    scAjaxHideErrorDisplay("mail_ativo");
    var var_idmail_meio = document.F2.idmail_meio.value;
    ...
    scAjaxProcOn();
    x_ajax_form_mail_meio_mob_navigate_form(var_idmail_meio, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_mail_meio_mob_navigate_form_cb);
  } // do_ajax_form_mail_meio_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_meio_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_mail_meio_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idmail_meio.value = scAjaxGetKeyValue("idmail_meio");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_mail_meio_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_mail_meio_mob_navigate_form_cb
  function do_ajax_form_mail_meio_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_mail_meio_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_mail_meio_mob_navigate_form_cb_after_alert
  function sc_hide_form_mail_meio_mob_form()
  {
  ...
  ajax_field_list[0] = "idmail_meio";
  ajax_field_list[1] = "mail_descreva";
  ajax_field_list[2] = "mail_usuario";
  ajax_field_list[3] = "mail_senha";
  ajax_field_list[4] = "mail_smtp";
  ajax_field_list[5] = "mail_porta";
  ajax_field_list[6] = "mail_seguranca";
  ajax_field_list[7] = "mail_ativo";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idmail_meio": {"label": "Idmail Meio", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mail_descreva": {"label": "Mail Descreva", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mail_usuario": {"label": "Mail Usuario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mail_senha": {"label": "Mail Senha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mail_smtp": {"label": "Mail Smtp", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mail_porta": {"label": "Mail Porta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mail_seguranca": {"label": "Mail Seguranca", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mail_ativo": {"label": "Mail Ativo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "idmail_meio": new Array(),
    "mail_descreva": new Array(),
    "mail_usuario": new Array(),
    "mail_senha": new Array(),
    "mail_smtp": new Array(),
    "mail_porta": new Array(),
    "mail_seguranca": new Array(),
    "mail_ativo": new Array()
  };
  ajax_field_mult["idmail_meio"][1] = "idmail_meio";
  ajax_field_mult["mail_descreva"][1] = "mail_descreva";
  ajax_field_mult["mail_usuario"][1] = "mail_usuario";
  ajax_field_mult["mail_senha"][1] = "mail_senha";
  ajax_field_mult["mail_smtp"][1] = "mail_smtp";
  ajax_field_mult["mail_porta"][1] = "mail_porta";
  ajax_field_mult["mail_seguranca"][1] = "mail_seguranca";
  ajax_field_mult["mail_ativo"][1] = "mail_ativo";

  var ajax_field_id = {
    "idmail_meio": new Array("hidden_field_label_idmail_meio", "hidden_field_data_idmail_meio"),
    "mail_descreva": new Array("hidden_field_label_mail_descreva", "hidden_field_data_mail_descreva"),
    "mail_usuario": new Array("hidden_field_label_mail_usuario", "hidden_field_data_mail_usuario"),
    "mail_senha": new Array("hidden_field_label_mail_senha", "hidden_field_data_mail_senha"),
    "mail_smtp": new Array("hidden_field_label_mail_smtp", "hidden_field_data_mail_smtp"),
    "mail_porta": new Array("hidden_field_label_mail_porta", "hidden_field_data_mail_porta"),
    "mail_seguranca": new Array("hidden_field_label_mail_seguranca", "hidden_field_data_mail_seguranca"),
    "mail_ativo": new Array("hidden_field_label_mail_ativo", "hidden_field_data_mail_ativo")
  };
