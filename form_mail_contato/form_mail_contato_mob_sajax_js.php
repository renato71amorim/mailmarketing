  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_mail_contato_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_mail_contato_mob_form();
	}

  // ---------- Validate email
  function do_ajax_form_mail_contato_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_contato_mob_validate_email(var_email, var_script_case_init, do_ajax_form_mail_contato_mob_validate_email_cb);
  } // do_ajax_form_mail_contato_mob_validate_email

  function do_ajax_form_mail_contato_mob_validate_email_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_contato_mob_validate_email_cb

  // ---------- Validate data_cadastro
  function do_ajax_form_mail_contato_mob_validate_data_cadastro()
  {
    var nomeCampo_data_cadastro = "data_cadastro";
    var var_data_cadastro = scAjaxGetFieldText(nomeCampo_data_cadastro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_contato_mob_validate_data_cadastro(var_data_cadastro, var_script_case_init, do_ajax_form_mail_contato_mob_validate_data_cadastro_cb);
  } // do_ajax_form_mail_contato_mob_validate_data_cadastro

  function do_ajax_form_mail_contato_mob_validate_data_cadastro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_contato_mob_validate_data_cadastro_cb

  // ---------- Validate data_atualizacao
  function do_ajax_form_mail_contato_mob_validate_data_atualizacao()
  {
    var nomeCampo_data_atualizacao = "data_atualizacao";
    var var_data_atualizacao = scAjaxGetFieldText(nomeCampo_data_atualizacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_contato_mob_validate_data_atualizacao(var_data_atualizacao, var_script_case_init, do_ajax_form_mail_contato_mob_validate_data_atualizacao_cb);
  } // do_ajax_form_mail_contato_mob_validate_data_atualizacao

  function do_ajax_form_mail_contato_mob_validate_data_atualizacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data_atualizacao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_contato_mob_validate_data_atualizacao_cb

  // ---------- Validate data_descadastramento
  function do_ajax_form_mail_contato_mob_validate_data_descadastramento()
  {
    var nomeCampo_data_descadastramento = "data_descadastramento";
    var var_data_descadastramento = scAjaxGetFieldText(nomeCampo_data_descadastramento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_contato_mob_validate_data_descadastramento(var_data_descadastramento, var_script_case_init, do_ajax_form_mail_contato_mob_validate_data_descadastramento_cb);
  } // do_ajax_form_mail_contato_mob_validate_data_descadastramento

  function do_ajax_form_mail_contato_mob_validate_data_descadastramento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data_descadastramento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_contato_mob_validate_data_descadastramento_cb

  // ---------- Validate motivo
  function do_ajax_form_mail_contato_mob_validate_motivo()
  {
    var nomeCampo_motivo = "motivo";
    var var_motivo = scAjaxGetFieldText(nomeCampo_motivo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_contato_mob_validate_motivo(var_motivo, var_script_case_init, do_ajax_form_mail_contato_mob_validate_motivo_cb);
  } // do_ajax_form_mail_contato_mob_validate_motivo

  function do_ajax_form_mail_contato_mob_validate_motivo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "motivo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_contato_mob_validate_motivo_cb

  // ---------- Validate origem
  function do_ajax_form_mail_contato_mob_validate_origem()
  {
    var nomeCampo_origem = "origem";
    var var_origem = scAjaxGetFieldText(nomeCampo_origem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_contato_mob_validate_origem(var_origem, var_script_case_init, do_ajax_form_mail_contato_mob_validate_origem_cb);
  } // do_ajax_form_mail_contato_mob_validate_origem

  function do_ajax_form_mail_contato_mob_validate_origem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "origem";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_contato_mob_validate_origem_cb

  // ---------- Validate nome
  function do_ajax_form_mail_contato_mob_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_contato_mob_validate_nome(var_nome, var_script_case_init, do_ajax_form_mail_contato_mob_validate_nome_cb);
  } // do_ajax_form_mail_contato_mob_validate_nome

  function do_ajax_form_mail_contato_mob_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_contato_mob_validate_nome_cb

  // ---------- Validate sexo
  function do_ajax_form_mail_contato_mob_validate_sexo()
  {
    var nomeCampo_sexo = "sexo";
    var var_sexo = scAjaxGetFieldText(nomeCampo_sexo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_contato_mob_validate_sexo(var_sexo, var_script_case_init, do_ajax_form_mail_contato_mob_validate_sexo_cb);
  } // do_ajax_form_mail_contato_mob_validate_sexo

  function do_ajax_form_mail_contato_mob_validate_sexo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sexo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_contato_mob_validate_sexo_cb

  // ---------- Validate aniversario
  function do_ajax_form_mail_contato_mob_validate_aniversario()
  {
    var nomeCampo_aniversario = "aniversario";
    var var_aniversario = scAjaxGetFieldText(nomeCampo_aniversario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_contato_mob_validate_aniversario(var_aniversario, var_script_case_init, do_ajax_form_mail_contato_mob_validate_aniversario_cb);
  } // do_ajax_form_mail_contato_mob_validate_aniversario

  function do_ajax_form_mail_contato_mob_validate_aniversario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aniversario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_contato_mob_validate_aniversario_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_mail_contato_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_mail_contato_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_email = scAjaxGetFieldText("email");
    var var_data_cadastro = scAjaxGetFieldText("data_cadastro");
    var var_data_atualizacao = scAjaxGetFieldText("data_atualizacao");
    var var_data_descadastramento = scAjaxGetFieldText("data_descadastramento");
    ...
    var var_aniversario = scAjaxGetFieldText("aniversario");
    ...
    scAjaxProcOn();
    x_ajax_form_mail_contato_mob_submit_form(var_email, var_data_cadastro, var_data_atualizacao, var_data_descadastramento, var_motivo, var_origem, var_nome, var_sexo, var_aniversario, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_mail_contato_mob_submit_form_cb);
  } // do_ajax_form_mail_contato_mob_submit_form

  function do_ajax_form_mail_contato_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("data_atualizacao");
      scAjaxHideErrorDisplay("data_descadastramento");
      scAjaxHideErrorDisplay("motivo");
      scAjaxHideErrorDisplay("origem");
      scAjaxHideErrorDisplay("nome");
      scAjaxHideErrorDisplay("sexo");
      scAjaxHideErrorDisplay("aniversario");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_mail_contato_mob_submit_form_cb_after_alert);
  } // do_ajax_form_mail_contato_mob_submit_form_cb
  function do_ajax_form_mail_contato_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_mail_contato_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_mail_contato_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("sexo");
    scAjaxHideErrorDisplay("aniversario");
    var var_email = document.F2.email.value;
    var var_origem = document.F2.origem.value;
    ...
    scAjaxProcOn();
    x_ajax_form_mail_contato_mob_navigate_form(var_email, var_origem, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_mail_contato_mob_navigate_form_cb);
  } // do_ajax_form_mail_contato_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_contato_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_mail_contato_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.email.value = scAjaxGetKeyValue("email");
    document.F2.origem.value = scAjaxGetKeyValue("origem");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_mail_contato_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_mail_contato_mob_navigate_form_cb
  function do_ajax_form_mail_contato_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_mail_contato_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_mail_contato_mob_navigate_form_cb_after_alert
  function sc_hide_form_mail_contato_mob_form()
  {
  ...
  ajax_field_list[2] = "data_atualizacao";
  ajax_field_list[3] = "data_descadastramento";
  ajax_field_list[4] = "motivo";
  ajax_field_list[5] = "origem";
  ajax_field_list[6] = "nome";
  ajax_field_list[7] = "sexo";
  ajax_field_list[8] = "aniversario";
  ...
  var ajax_error_list = {
    ...
    "data_atualizacao": {"label": "Data Atualizacao", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "data_descadastramento": {"label": "Data Descadastramento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "aniversario": {"label": "Aniversario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "data_atualizacao": new Array(),
    "data_descadastramento": new Array(),
    "motivo": new Array(),
    "origem": new Array(),
    "nome": new Array(),
    "sexo": new Array(),
    "aniversario": new Array()
  };
  ajax_field_mult["email"][1] = "email";
  ajax_field_mult["data_cadastro"][1] = "data_cadastro";
  ajax_field_mult["data_atualizacao"][1] = "data_atualizacao";
  ajax_field_mult["data_descadastramento"][1] = "data_descadastramento";
  ajax_field_mult["motivo"][1] = "motivo";
  ajax_field_mult["origem"][1] = "origem";
  ajax_field_mult["nome"][1] = "nome";
  ajax_field_mult["sexo"][1] = "sexo";
  ajax_field_mult["aniversario"][1] = "aniversario";
  ...
  var ajax_field_id = {
    ...
    "data_atualizacao": new Array("hidden_field_label_data_atualizacao", "hidden_field_data_data_atualizacao"),
    "data_descadastramento": new Array("hidden_field_label_data_descadastramento", "hidden_field_data_data_descadastramento"),
    ...
    "aniversario": new Array("hidden_field_label_aniversario", "hidden_field_data_aniversario")
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("data_descadastramento" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
