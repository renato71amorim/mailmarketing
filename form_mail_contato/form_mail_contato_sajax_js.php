  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_mail_contato" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_mail_contato_form();
	}

  // ---------- Validate email
  function do_ajax_form_mail_contato_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_contato_validate_email(var_email, var_script_case_init, do_ajax_form_mail_contato_validate_email_cb);
  } // do_ajax_form_mail_contato_validate_email

  function do_ajax_form_mail_contato_validate_email_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_contato_validate_email_cb

  // ---------- Validate data_cadastro
  function do_ajax_form_mail_contato_validate_data_cadastro()
  {
    var nomeCampo_data_cadastro = "data_cadastro";
    var var_data_cadastro = scAjaxGetFieldText(nomeCampo_data_cadastro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_contato_validate_data_cadastro(var_data_cadastro, var_script_case_init, do_ajax_form_mail_contato_validate_data_cadastro_cb);
  } // do_ajax_form_mail_contato_validate_data_cadastro

  function do_ajax_form_mail_contato_validate_data_cadastro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_contato_validate_data_cadastro_cb

  // ---------- Validate data_atualizacao
  function do_ajax_form_mail_contato_validate_data_atualizacao()
  {
    var nomeCampo_data_atualizacao = "data_atualizacao";
    var var_data_atualizacao = scAjaxGetFieldText(nomeCampo_data_atualizacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_contato_validate_data_atualizacao(var_data_atualizacao, var_script_case_init, do_ajax_form_mail_contato_validate_data_atualizacao_cb);
  } // do_ajax_form_mail_contato_validate_data_atualizacao

  function do_ajax_form_mail_contato_validate_data_atualizacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_contato_validate_data_atualizacao_cb

  // ---------- Validate data_descadastramento
  function do_ajax_form_mail_contato_validate_data_descadastramento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_contato_validate_data_descadastramento(var_data_descadastramento, var_script_case_init, do_ajax_form_mail_contato_validate_data_descadastramento_cb);
  } // do_ajax_form_mail_contato_validate_data_descadastramento

  function do_ajax_form_mail_contato_validate_data_descadastramento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_contato_validate_data_descadastramento_cb

  // ---------- Validate motivo
  function do_ajax_form_mail_contato_validate_motivo()
  {
    var nomeCampo_motivo = "motivo";
    var var_motivo = scAjaxGetFieldText(nomeCampo_motivo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_contato_validate_motivo(var_motivo, var_script_case_init, do_ajax_form_mail_contato_validate_motivo_cb);
  } // do_ajax_form_mail_contato_validate_motivo

  function do_ajax_form_mail_contato_validate_motivo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "motivo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_contato_validate_motivo_cb

  // ---------- Validate origem
  function do_ajax_form_mail_contato_validate_origem()
  {
    var nomeCampo_origem = "origem";
    var var_origem = scAjaxGetFieldText(nomeCampo_origem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_contato_validate_origem(var_origem, var_script_case_init, do_ajax_form_mail_contato_validate_origem_cb);
  } // do_ajax_form_mail_contato_validate_origem

  function do_ajax_form_mail_contato_validate_origem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "origem";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_contato_validate_origem_cb

  // ---------- Validate nome
  function do_ajax_form_mail_contato_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_contato_validate_nome(var_nome, var_script_case_init, do_ajax_form_mail_contato_validate_nome_cb);
  } // do_ajax_form_mail_contato_validate_nome

  function do_ajax_form_mail_contato_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_contato_validate_nome_cb

  // ---------- Validate sexo
  function do_ajax_form_mail_contato_validate_sexo()
  {
    var nomeCampo_sexo = "sexo";
    var var_sexo = scAjaxGetFieldText(nomeCampo_sexo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_contato_validate_sexo(var_sexo, var_script_case_init, do_ajax_form_mail_contato_validate_sexo_cb);
  } // do_ajax_form_mail_contato_validate_sexo

  function do_ajax_form_mail_contato_validate_sexo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sexo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_contato_validate_sexo_cb

  // ---------- Validate aniversario
  function do_ajax_form_mail_contato_validate_aniversario()
  {
    var nomeCampo_aniversario = "aniversario";
    var var_aniversario = scAjaxGetFieldText(nomeCampo_aniversario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mail_contato_validate_aniversario(var_aniversario, var_script_case_init, do_ajax_form_mail_contato_validate_aniversario_cb);
  } // do_ajax_form_mail_contato_validate_aniversario

  function do_ajax_form_mail_contato_validate_aniversario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mail_contato_validate_aniversario_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_mail_contato_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_mail_contato_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_mail_contato_submit_form(var_email, var_data_cadastro, var_data_atualizacao, var_data_descadastramento, var_motivo, var_origem, var_nome, var_sexo, var_aniversario, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_mail_contato_submit_form_cb);
  } // do_ajax_form_mail_contato_submit_form

  function do_ajax_form_mail_contato_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_mail_contato_submit_form_cb_after_alert);
  } // do_ajax_form_mail_contato_submit_form_cb
  function do_ajax_form_mail_contato_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_mail_contato_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_mail_contato_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_mail_contato_navigate_form(var_email, var_origem, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_mail_contato_navigate_form_cb);
  } // do_ajax_form_mail_contato_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mail_contato']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_mail_contato_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_mail_contato_navigate_form_cb_after_alert);
  } // do_ajax_form_mail_contato_navigate_form_cb
  function do_ajax_form_mail_contato_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_mail_contato_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_mail_contato_navigate_form_cb_after_alert
  function sc_hide_form_mail_contato_form()
  {
