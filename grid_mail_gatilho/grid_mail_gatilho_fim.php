...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["mail_marketing_____grid_mail_gatilho"]))
   {
      unset($_SESSION['session_sec_aplicacao']["mail_marketing_____grid_mail_gatilho"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_mail_gatilho'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mail_gatilho']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_mail_gatilho']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mail_gatilho']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_mail_gatilho']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_mail_gatilho']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_mail_gatilho']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_mail_gatilho']['embutida_filho'] as $ind => $sc_init)
          {
