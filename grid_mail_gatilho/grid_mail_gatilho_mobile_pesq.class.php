...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idmail_gatilho";$Nm_numeric[] = "idmail_gatilho";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idmail_gatilho_cond" name="idmail_gatilho_cond" onChange="nm_campos_between(document.getElementById('id_vis_idmail_gatilho'), this, 'idmail_gatilho')">
      ...
      <br><span id="id_hide_idmail_gatilho"  <?php echo $str_hide_idmail_gatilho?>><INPUT  type="text" id="SC_idmail_gatilho" name="idmail_gatilho" value="<?php echo NM_encode_input($idmail_gatilho) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_mail_descreva_cond" name="mail_descreva_cond" onChange="nm_campos_between(document.getElementById('id_vis_mail_descreva'), this, 'mail_descreva')">
