...
class menu_mail_form_php
{
   ...
   function init()
   {
      ...
      if(!isset($_SESSION['scriptcase']['menu_mail']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['menu_mail']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['menu_mail']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
';
      ...
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['menu_mail'] as $id_item => $arr_item)
         {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="menu_mail"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "menu_mail")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'menu_mail', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
<?php
   ...
   function Gera_sc_init($apl_menu)
   {
        ...
        $this->menu_sc_init = $_SESSION['scriptcase']['menu_mail']['sc_init'][$apl_menu];
...
$controle = new menu_mail_form_php();
$controle->init();
?>
