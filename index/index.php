<?php
   ...
   $_SESSION['scriptcase']['index']['glo_nm_path_imagens']    = "/principal/img";
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['index']['glo_nm_conexao'], $this->root . $this->path_prod, 'mail_marketing', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
";
 ...
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('menu_mail') . "/", $this->nm_location, "","_self", 440, 630, "ret_self");
 };
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['index']['glo_nm_path_imag_temp'] . "/sc_apl_default_mail_marketing.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['index']['glo_nm_path_imag_temp'] . "/sc_apl_default_mail_marketing.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "index") {
           ...
           if (isset($_COOKIE['sc_actual_lang_mail_marketing'])) {
               $_SESSION['scriptcase']['index']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_mail_marketing'];
           }
       }
   }
