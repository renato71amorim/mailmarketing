<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['blank']['glo_nm_perfil']          = "principal";
   $_SESSION['scriptcase']['blank']['glo_nm_path_prod']       = "/principal/prod";
   $_SESSION['scriptcase']['blank']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['blank']['glo_nm_path_imagens']    = "/principal/img";
   $_SESSION['scriptcase']['blank']['glo_nm_path_imag_temp']  = "/principal/tmp";
   $_SESSION['scriptcase']['blank']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['blank']['glo_nm_path_doc']        = "/var/www/doc";
...
//
   function init($Tp_init = "")
   {
      ...
      $this->nm_dt_criacao   = "20201114"; 
      $this->nm_hr_criacao   = "164244"; 
      $this->nm_autor_alt    = "admin"; 
      $this->nm_dt_ult_alt   = "20201114"; 
      $this->nm_hr_ult_alt   = "164502"; 
...
/*NM*/            $_SESSION['scriptcase']['blank']['glo_nm_perfil'] = $NM_con_dest;
      ...
      {
          if (!isset($_SESSION['nomeE'])) 
          {
              $this->nm_falta_var .= "nomeE; ";
          }
          if (!isset($_SESSION['idE'])) 
          {
              $this->nm_falta_var .= "idE; ";
          }
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank']['glo_nm_conexao'], $this->root . $this->path_prod, 'mail_marketing', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
if (!isset($_SESSION['idE'])) {$_SESSION['idE'] = "";}
if (!isset($this->sc_temp_idE)) {$this->sc_temp_idE = (isset($_SESSION['idE'])) ? $_SESSION['idE'] : "";}
if (!isset($_SESSION['nomeE'])) {$_SESSION['nomeE'] = "";}
if (!isset($this->sc_temp_nomeE)) {$this->sc_temp_nomeE = (isset($_SESSION['nomeE'])) ? $_SESSION['nomeE'] : "";}
  
$html = $geradorDeHtml->geraHtml($this->sc_temp_nomeE,$this->sc_temp_idE);
$mail->MsgHTML($html);
$mail->IsHtml(true);
if (isset($this->sc_temp_nomeE)) {$_SESSION['nomeE'] = $this->sc_temp_nomeE;}
if (isset($this->sc_temp_idE)) {$_SESSION['idE'] = $this->sc_temp_idE;}
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['blank']['glo_nm_path_imag_temp'] . "/sc_apl_default_mail_marketing.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['blank']['glo_nm_path_imag_temp'] . "/sc_apl_default_mail_marketing.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "blank") {
           ...
           if (isset($_COOKIE['sc_actual_lang_mail_marketing'])) {
               $_SESSION['scriptcase']['blank']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_mail_marketing'];
           }
       }
   }
   ...
   {
       $_SESSION["nomeE"] = $_POST["nomeE"];
       nm_limpa_str_blank($_SESSION["nomeE"]);
   }
   if (!isset($_POST["nomeE"]) && isset($_POST["nomee"])) 
   {
       $_SESSION["nomeE"] = $_POST["nomee"];
       nm_limpa_str_blank($_SESSION["nomeE"]);
   }
   if (isset($_GET["nomeE"])) 
   {
       $_SESSION["nomeE"] = $_GET["nomeE"];
       nm_limpa_str_blank($_SESSION["nomeE"]);
   }
   if (!isset($_GET["nomeE"]) && isset($_GET["nomee"])) 
   {
       $_SESSION["nomeE"] = $_GET["nomee"];
       nm_limpa_str_blank($_SESSION["nomeE"]);
   }
   ...
   if (isset($_POST["idE"])) 
   {
       ...
       nm_limpa_str_blank($_SESSION["idE"]);
   }
   if (!isset($_POST["idE"]) && isset($_POST["ide"])) 
   {
       $_SESSION["idE"] = $_POST["ide"];
       nm_limpa_str_blank($_SESSION["idE"]);
   }
   ...
   if (!isset($_GET["idE"]) && isset($_GET["ide"])) 
   {
       $_SESSION["idE"] = $_GET["ide"];
       nm_limpa_str_blank($_SESSION["idE"]);
   }
   ...
   { 
       ...
       if (!isset($nomeE) && isset($nomee)) 
       {
           $_SESSION["nomeE"] = $nomee;
       }
       if (isset($nomeE)) 
       {
           $_SESSION['nomeE'] = $nomeE;
