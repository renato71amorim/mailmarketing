...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["mail_marketing_____grid_mail_contato"]))
   {
      unset($_SESSION['session_sec_aplicacao']["mail_marketing_____grid_mail_contato"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mail_contato']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_mail_contato']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mail_contato']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_mail_contato']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_mail_contato']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_mail_contato']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_mail_contato']['embutida_filho'] as $ind => $sc_init)
          {
